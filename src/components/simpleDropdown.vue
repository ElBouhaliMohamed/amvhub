<template>
    <div ref="menu" @keydown.window.escape="open = false" class="relative inline-block text-left">
        <div>
        ...
        >
            <div v-show="open" class="absolute right-0 z-10 w-56 mt-2 origin-top-right transform rounded-md shadow-lg">
