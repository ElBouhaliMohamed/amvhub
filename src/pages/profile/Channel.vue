<template>
  <div class="bg-gray-50 min-h-screen">
      <div class="relative pb-1/6">
        <img src="@/assets/banner.jpg" class="absolute h-full w-full object-cover">
      </div>
      <div class="container mx-auto flex items-center relative">
          <img src="@/assets/avatar.jpg" alt="avatar" class="absolute ml-6 w-16 h-16 sm:w-32 sm:h-32 lg:w-48 lg:h-48 xl:w-64 xl:h-64 rounded-full">
      </div>
      <div class="bg-gray-900 pt-36 px-8 pb-8">
        <div class="lg:flex lg:items-center lg:justify-between">
          ...
          <div class="mt-5 flex lg:mt-0 lg:ml-4">
            ...
            <span class="sm:ml-3 shadow-sm rounded-md">
              <button type="button" class="inline-flex items-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-indigo-500 hover:bg-indigo-400 focus:outline-none focus:shadow-outline-indigo focus:border-indigo-600 active:bg-indigo-600 transition duration-150 ease-in-out">
            ...
            <span x-data="{ open: false }" class="ml-3 relative shadow-sm rounded-md sm:hidden">
              <button @click="open = !open" type="button" class="inline-flex items-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-gray-700 hover:bg-gray-600 focus:outline-none focus:shadow-outline-gray focus:border-gray-800 transition duration-150 ease-in-out">
                More
      ...
      <!-- <div class="container mx-auto bg-white text-black">
          <ul class="flex">
              <li class="text-center py-3 px-4"><a class="text-white" href="#" target="_blank" rel="noopener noreferrer"> Videos </a></li>
              <li class="text-center py-3 px-4"><a class="text-white" href="#" target="_blank" rel="noopener noreferrer"> Following </a></li>
              <li class="text-center py-3 px-4"><a class="text-white" href="#" target="_blank" rel="noopener noreferrer"> Followers </a></li>
          </ul>
      </div> -->
