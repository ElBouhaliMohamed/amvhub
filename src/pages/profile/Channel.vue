<template>
  <div class="bg-gray-50 min-h-screen">
      <div class="relative pb-1/6">
        ...
        <div class="absolute bottom-0 right-0 container mx-auto pl-64 pr-16 pb-2 lg:flex lg:items-center lg:justify-between bg-indigo-500 h-32 rounded-lg opacity-75"></div>
        <div class="absolute bottom-0 right-0 container mx-auto pl-64 pr-16 pb-4 lg:flex lg:items-center lg:justify-between">
