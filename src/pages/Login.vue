<template>
    <div>
            ...
            <div>
              <div>
                <div class="mt-1 grid grid-cols-3 gap-3">
                  <div>
                    <span class="w-full inline-flex rounded-md shadow-sm hidden">
                  ...
                  <div>
                    <span class="w-full inline-flex rounded-md shadow-sm">
                      <button @click="loginWithGoogle" type="button" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md bg-white text-sm leading-5 font-medium text-gray-500 hover:text-gray-400 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue transition duration-150 ease-in-out">
                        <!-- <svg class="h-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          ...
          <form v-on:submit.prevent class="mt-8" action="#" method="POST">
            ...
            <div class="mt-6 flex items-center justify-between">
              ...
              <div class="text-sm leading-5">
                <router-link to="passwordreset" class="font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">
      ...
      <transition name="fade">
        <div class="fixed flex justify-center items-center inset-0 bg-gray-600 opacity-75 z-50" v-if="loading">
        </div>
      </transition>
        <div class="fixed flex justify-center items-center inset-0 z-50" v-if="loading">
          <loadingAnimation class="opacity-100 h-16 w-16" />
        </div>
    </div>
</template>
