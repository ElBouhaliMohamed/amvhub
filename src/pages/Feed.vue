<template>
  <div class="h-full bg-white">
    <div v-if="isLoggedIn && canLoad">
                ...
                <div class="flex flex-row flex-1 min-w-0 md:flex-col">
                  <div class="flex-shrink-0 block pl-4 group focus:outline-none">
                    <div class="flex items-center">
                      <router-link :to="`/channel/${video.user.uuid}`">
                        ...
                        <div class="flex pt-1 md:block">
                          <div class="block">
                            ...
                            <span class="flex flex-col px-4 text-xs font-thin leading-5 text-gray-500 md:flex-row md:text-sm">
                              <router-link :to="`/channel/${video.user.uuid}`" class="block font-medium leading-5 truncate md:hidden">{{video.user.name}}</router-link>
                              <span class="flex flex-row">
                                <span>{{video.views}} views</span>
                                <span class="block px-1 md:px-2">&#8226;</span>
                                <time v-bind:datetime="video.date[0]">{{video.date[1]}}</time>
                              </span>
                              <p class="block w-full text-sm font-thin text-gray-900 md:hidden">
                          ...
                          <p class="hidden px-4 py-2 text-sm font-thin text-gray-900 md:block">
                          Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate, totam in? Magni dignissimos eveniet autem, corporis rerum est quas porro officia numquam non voluptatibus, doloribus aliquid esse voluptatum a odit.
                          </p>
                        </div>
                    </div>
      ...
      <div class="container flex flex-col hidden mx-auto md:w-3/4 lg:w-1/2">
        <div class="flex flex-row feed-entry">
          ...
          <div class="flex flex-col w-full">
            <div class="flex flex-row items-center justify-start text-center">
              ...
              <span class="pl-2 text-xs font-hairline opacity-75" href>@Kazumoe</span>
              <span class="px-2 text-xs font-hairline opacity-25">&#8226;</span>
              <span class="text-xs font-hairline opacity-75">8 hours ago</span>
            </div>
            ...
            <div class="flex flex-row items-center pt-2">
              <button class="flex mr-1 btn-xs btn-action">
                <span class="mr-1 fas fa-heart"></span>
                <span class="mr-1 text-xs">6</span>
              </button>

              <button class="flex p-2 mr-1 btn-xs btn-action">
                <span class="mr-1 text-xs">2</span>
                <span class="fas fa-comments"></span>
              </button>

              <button class="flex p-2 btn-xs btn-action">
                <span class="mx-1 fas fa-retweet"></span>
              </button>
            </div>
          </div>
        </div>
        <div class="flex flex-col feed-entry">
          ...
          <div class="flex">
            ...
            <div class="flex flex-col">
              <span class="px-4 text-2xl font-bold">Beautiful Crime</span>
              <span class="flex flex-col px-4 text-xs font-thin md:flex-row">
                <span>Kazumoe</span>
                <span class="hidden px-2 md:block">&#8226;</span>
                <span>688 views</span>
                <span class="hidden px-2 md:block">&#8226;</span>
                <span>4 Months ago</span>
              </span>
              <span
                class="hidden px-4 py-2 text-sm font-thin md:block"
          ...
          <span
            class="block py-2 text-sm font-thin md:hidden"
          >Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate, totam in? Magni dignissimos eveniet autem, corporis rerum est quas porro officia numquam non voluptatibus, doloribus aliquid esse voluptatum a odit.</span>
        </div>
        <div class="flex flex-row feed-entry">
          <span class="flex flex-col items-center">
          ...
          <div class="flex flex-col w-full">
            ...
            <div class="flex flex-col">
              ...
              <div class="flex flex-row px-4 py-2 mt-2 bg-gray-700 rounded-lg">
                <span class="flex flex-col items-center">
                ...
                <div class="flex flex-col w-full">
                  <div class="flex flex-col justify-start md:flex-row">
                    ...
                    <span class="hidden px-4 text-xs md:block">&#8226;</span>
                    <span class="text-sm font-thin">8 hours ago</span>
                  </div>
            ...
            <div class="flex flex-row items-center pt-2">
              <button class="p-2 rounded-full hover">
