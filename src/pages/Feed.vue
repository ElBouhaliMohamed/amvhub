<template>
  <div class="container mx-auto md:w-3/4 lg:w-1/2 flex flex-col bg-background p-2">
    <div class="flex flex-row">
      ...
      <div class="flex flex-col w-full">
        ...
        <div class="flex flex-row pt-2 items-center">
          <button class="btn-xs-rounded btn-brand mr-1 p-2">
            <span class="mr-1">6</span>
            <span class="fas fa-heart"></span>
          </button>

          <button class="btn-xs-rounded btn-primary mr-1 p-2">
            <span class="mr-1">2</span>
            <span class="fas fa-comments"></span>
          </button>

          <button class="btn-xs-rounded btn-primary p-2">
            <span class="fas fa-retweet mx-1"></span>
          </button>
        </div>
      </div>
    </div>
    <span class="border-b-2 w-full my-2"></span>
    ...
    <div class="flex flex-row">
      ...
      <div class="flex flex-col w-full">
        ...
        <div class="flex flex-col">
          ...
          <div class="flex flex-row border-2 rounded-lg mt-2 px-4 py-2">
            <span class="flex flex-col items-center">
