<template>
  <nav v-if="headerEnabled" class="transition-colors duration-700 headerContainer" :class="{'bg-gray-900': !theaterMode, 'bg-black': theaterMode}">
    <div class="flex w-11/12 sm:w-2/5">
    ...
    <div class="flex items-center justify-end w-full mt-2 text-center md:w-2/5">
      ...
      <!-- <transition
        enter-class="transition-all duration-500 ease-out"
        enter-active-class="scale-95 opacity-0"
        enter-to-class="scale-100 opacity-100"
        leave-class="transition-all duration-500 ease-in"
        leave-active-class="scale-100 opacity-100"
